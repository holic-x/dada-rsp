				...
				<div class="panel panel-default">
					<div style="padding: 0px; margin: 0px;">
						<ul class="breadcrumb" style="margin: 0px;">
							<li><a href="#">平台案例</a></li>
							<li>employee-员工工资信息统计错行报表(部门、学历)</li>
						</ul>
					</div>
					...
					<div class="panel-heading btn-group operation">
						...
						<a title="WORD导出" href="<%=request.getContextPath() %>/ureport/word?_u=file:employee_salary_by_degree_cross.ureport.xml">
							<img src="${pageContext.request.contextPath }/icon/file_tools/doc.png" />
						</a>
						<a title="EXCEL导出" href="<%=request.getContextPath() %>/ureport/excel?_u=file:employee_salary_by_degree_cross.ureport.xml">
							<img src="${pageContext.request.contextPath }/icon/file_tools/excel.png" />
						</a>
						<a title="分页EXCEL导出" href="<%=request.getContextPath() %>/ureport/excel/paging?_u=file:employee_salary_by_degree_cross.ureport.xml">
							<img src="${pageContext.request.contextPath }/icon/file_tools/excel-page.png" />
						</a>
						<a title="分页分Sheet的EXCEL导出" href="<%=request.getContextPath() %>/ureport/excel/sheet?_u=file:employee_salary_by_degree_cross.ureport.xml">
							<img src="${pageContext.request.contextPath }/icon/file_tools/excel-sheet.png" />
						</a>
						<a title="PDF导出" href="<%=request.getContextPath() %>/ureport/pdf?_u=file:employee_salary_by_degree_cross.ureport.xml">
							<img src="${pageContext.request.contextPath }/icon/file_tools/pdf.png" />
						</a>
						<a title="PDF在线预览" href="<%=request.getContextPath() %>/ureport/pdf/show?_u=file:employee_salary_by_degree_cross.ureport.xml">
					...
					<div class="panel-body">
						...
						<%-- <a href="<%=request.getContextPath() %>/ureport/pdf?_u=file:employee_salary_by_degree_cross.ureport.xml">导出PDF格式报表</a> --%>
						<p></p>
						<%
							ExportManager  exportManager=(ExportManager)Utils.getApplicationContext().getBean(ExportManager.BEAN_ID);
							Map<String,Object> parameters=new HashMap<String,Object>();
							HtmlReport htmlReport = exportManager.exportHtml("file:employee_salary_by_degree_cross.ureport.xml",request.getContextPath(),parameters);
							//输出CSS样式
