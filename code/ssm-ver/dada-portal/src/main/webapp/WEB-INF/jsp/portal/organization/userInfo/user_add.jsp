...
<script type="text/javascript">
	...
	function loadData() {
		...
		// 初始化用户类型为“机构用户”(在选择的时候默认禁用用户类型选择按钮)
		// document.getElementById("categoryId").value=$("#categoryId").val();
...
<body onload="loadData()">
							...
							<form id="submitForm" class="form-horizontal" action="#">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="userCategory" name="userCategory"
													...
													<option value="1" selected="selected">默认所属机构用户</option>
												</select>
											</div>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="categoryId" name="categoryId"
													...
													disabled="disabled">
													<option value="${loginUser.categoryId }">默认所属机构</option>
												</select>
											</div>
								...
								<div class="row">
									<div class="col-sm-3 col-sm-offset-4">
										...
										<a class="btn btn-warning" href="${pageContext.request.contextPath }/portal/page/other?url=portal/organization/userInfo/user_list">返回上一级</a>
									</div>
								</div>
							</form>
						</div>
	...
	$("#submitButton").click(function() {//非submit按钮点击后进行验证，如果是submit则无需此句直接验证
		...
		if (validator.isValid()) {
			...
			$.ajax({
				url : contentPath + '/organization/addUserInfo',
				type : 'POST',
				contentType : 'application/json; charset=UTF-8',
				async : false,
				dataType : 'json',
