...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">添加角色信息</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form id="submitForm" class="form-horizontal" action="#">
							...
							<input type="hidden" id="userId" name="userId" value="${roleInfo.userId }" />
									...
									<div id="roleCodeGroup" class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="roleCode" name="roleCode"
												   class="form-control input-sm" placeholder="请输入角色编码" />
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												<textarea class="form-control" rows="3" cols="50"
														  ...
														  placeholder="请填写角色备注信息"></textarea>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-3 col-sm-offset-4">
									...
									<a class="btn btn-warning" href="${pageContext.request.contextPath }/manager/page/other?url=admin/system/roleInfo/role_list">返回上一级</a>
								</div>
							</div>
						</form>
					</div>
     	...
     	if (validator.isValid()) {
        	...
        	// 1.封装页面json角色
         	var submitData = {
           	...
           	$.ajax({
           		url :'${pageContext.request.contextPath}/portal/system/addRoleInfo',
               	type : 'POST',
             	...
             	async : false,
              	...
              	success : function(responseData) {
              		...
              		if (result_code == "1") {
                 		...
                 		alert('角色修改成功,正在返回页面!');
                  		// 如果角色修改成功跳转到list页面
                   		var url = "${pageContext.request.contextPath }/manager/page/other?url=admin/system/roleInfo/role_list";
