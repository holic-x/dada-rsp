...
<body onload="loadData()">
	...
	<div id="wrapper">
		...
		<div class="admin-content">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">&nbsp;添加数据源信息</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea class="form-control" rows="3" cols="50"
													...
													placeholder="请填写数据源备注信息"></textarea>
											</div>
										</div>
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		$("#submitButton").click(function() {
			...
			if (validator.isValid()) {
				...
				$.ajax({
					url :'${pageContext.request.contextPath}/portal/dataSource/addDataSource',
					type : 'POST',
