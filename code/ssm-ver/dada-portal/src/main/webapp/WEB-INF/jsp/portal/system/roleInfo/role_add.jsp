								...
								<div class="row">
									<div class="col-sm-5">
										<div id="roleCodeGroup" class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="roleCode" name="roleCode" value="-1"
									...
									<div class="col-sm-5">
										<div class="form-group">
											...
											<div class="col-sm-9">
												...
												<input type="text" id="categoryName" name="categoryName" value="默认当前所属机构" class="form-control input-sm" disabled="disabled"/>
											</div>
										</div>
									</div>
								</div>
