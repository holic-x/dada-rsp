									...
									<div class="col-sm-5">
										<div class="form-group">
											...
											<div class="col-sm-9">
												...
												<input type="text" id="categoryName" name="categoryName" class="form-control input-sm" disabled="disabled"/>
											</div>
										</div>
									</div>
								</div>
				...
				$.ajax({
					...
					success : function(responseData) {
						...
						if (result_code == "1") {
							...
							alert('角色添加成功,正在返回页面!');
							// 如果角色添加成功跳转到list页面
							var url = "${pageContext.request.contextPath }/portal/page/other?url=admin/system/roleInfo/role_list";
