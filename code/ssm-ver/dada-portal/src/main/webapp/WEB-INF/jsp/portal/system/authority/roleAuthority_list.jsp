...
<body>
		...
		$(document).ready(function() {
			...
			columns : [
				...
				} */
				{
					...
					"data" : null,
					"className" : "center",
					"defaultContent" : '<button type="button" id="editrow" data-toggle="modal" class="btn btn-outline btn-circle btn-sm purple"><i class="fa fa-edit">角色权限变更</i></button>'
				}
			]
		});
	});
	...
	$('#dataTables-example').on('click','button#editrow',function(even) {
		...
		// 封装选择的数据行
		var url = "${pageContext.request.contextPath }/portal/system/updateRoleAuthorityUI/"+ data.roleId;
		// 考虑触发模态框实现数据变更
