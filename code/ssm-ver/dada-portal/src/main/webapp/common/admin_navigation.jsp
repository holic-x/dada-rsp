	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<!-- 系统管理：角色管理、权限管理 -->
				<li><a href="#"><i class="fa fa-wrench fa-fw"></i>系统管理 <span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="${pageContext.request.contextPath }/portal/page/other?url=admin/system/roleInfo/role_list">角色管理</a></li>
						<li><a href="${pageContext.request.contextPath }/portal/page/other?url=admin/system/authority/">权限管理</a></li>
				...
				<li><a href="#"><i class="fa fa-sitemap fa-fw"></i>模板管理<span
					...
					<ul class="nav nav-second-level">
						...
						<li><a href="${pageContext.request.contextPath }/manager/page/other?url=">模板审核</a></li>
					</ul> <!-- /.nav-second-level --></li>
