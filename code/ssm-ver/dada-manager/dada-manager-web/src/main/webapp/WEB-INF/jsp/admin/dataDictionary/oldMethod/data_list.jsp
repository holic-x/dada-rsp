							...
							<table width="100%"
								...
								<thead>
									<tr>
										...
										<th class="text-center">数据编码</th>
										<th class="text-center">数据名称</th>
										<th class="text-center">数据类型</th>
										<th class="text-center">数据描述</th>
		...
		$("#btn_add")
				.click(
						function() {
							...
							alert('add');
							// 跳转到用户添加页面
							var url = "${pageContext.request.contextPath }/manager/page/other?url=dataDictionary/data_add";
				...
				.on(
						...
						function(even) {
							...
							var data = $("#dataTables-example").DataTable()
									.row($(this).parents('tr')).data();
							// 封装选择的数据行
							var url = "${pageContext.request.contextPath }/manager/dataDictionary/updateDataUI?dataId="
									+ data.dataId;
							window.location.href = url;
						});
		// 时间转化
